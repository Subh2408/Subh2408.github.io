...
date: 2025-04-01
description: >-
  Notes on street photography: finding the subject first, then deciding what part of the moment you are actually trying to keep.
tags: ["Photography", "Street"]
readTime: "3 min read"
draft: false
---

For street photography, the goal is to look for **subjects first**.  
