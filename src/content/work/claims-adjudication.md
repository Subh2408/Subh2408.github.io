...
description: >-
  Replaced manual first-pass review at a Fortune 100 insurer with document AI and a predictive eligibility model, cutting adjudication from 15 to 24 hours to about fifteen minutes.
cover: "/images/projects/Insurance.jpg"
kpis:
  - value: "15 hrs → ~15 min"
...
chips:
  stack: ["AWS Textract", "AWS SageMaker", "XGBoost"]
  domain: ["Insurance", "Claims"]
  method: ["Discovery", "SOP mapping", "User-centred design"]
---

Delivered a scalable, AI-driven adjudication platform for a **Fortune 100 insurance provider**, achieving a landmark reduction in claims processing time from **15–24 hours to about fifteen minutes**. This solution utilised **AWS Textract** for intelligent document digitisation and **AWS SageMaker** for predictive modelling. Led a cross-functional team of 10+ professionals (data scientists, ML/data engineers), overseeing the project lifecycle from problem discovery through to deployment and delivery.
...
## The Challenge: Modernising Claims Adjudication
...
2.  **User-centred design:** Mapped adjudicator SOPs and decision logic to ensure the AI solution complemented and enhanced their expertise.
...
-   **Predictive Modelling (Eligibility & Payout):** Utilised custom ML models (built with AWS SageMaker) trained on historical data to predict claim eligibility and estimate appropriate payout ranges.
...
-   **Human-in-the-Loop Governance:** Ensured all AI-driven recommendations were reviewed by human adjudicators before finalisation, maintaining accountability and trust.
...
-   **Drastic Turnaround Time Reduction**: Claims processing time cut from 15 hours to **about fifteen minutes per claim**.
-   **Enhanced Operational Efficiency**: Improved data standardisation and accuracy, reducing manual errors and pre-check workloads.
