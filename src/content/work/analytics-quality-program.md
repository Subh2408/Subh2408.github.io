---
title: "Quality check programme for an analytics function"
...
readTime: "3 min read"
description: >-
  A quality control programme across analytics pods — checklists, documentation standards and reusable templates — designed to raise the floor without flattening exploratory work.
cover: "/images/projects/QC.jpg"
kpis:
  - value: "50%"
...
The new QC programme resulted in immediate operational benefits. Turnaround time for typical deliverables was halved, largely due to a reduction in rework and clarification loops. Data-related errors saw a 70% decline, and feedback from senior stakeholders highlighted a marked improvement in the quality and consistency of insights. Junior analysts were able to ramp up faster, and pods reported smoother cross-collaboration owing to standardised output formats.

---

### Next Steps

The checklists were being adapted into Jira workflows, enabling automated task-level QC integration. The aim was to embed quality assurance further into the fabric of project delivery without manual oversight.
